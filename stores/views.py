...
def product_by_brand(request):
    ...
    f.save('/Users/Pioneer/www/markpro/media/products_by_brand.xls')
...
def product_by_date(request):
    ...
    paginator=Paginator(p_results,5)
    ...
    f.save('/Users/Pioneer/www/markpro/media/products_by_date.xls')
    f.save(TemporaryFile())
